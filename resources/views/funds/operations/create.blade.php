...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route($fundOperation->id?'funds.operations.update':'funds.operations.store' , ['fund' => $fund, 'fundOperation' => $fundOperation])}}">
            @csrf
            @if($fundOperation->id)
            @method('PUT')
            @endif
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="datetime-local" class="form-control form-control-user @error('date') is-invalid @enderror"  placeholder="Date" name="date" value="{{ old('date', $fundOperation->date) }}">
