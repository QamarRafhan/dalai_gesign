...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{ route('reports.update', ['report' => $report->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" placeholder="Name" name="name" value="{{ old('name',$report->name)}}">
                    </div>
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
