            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('first_name') is-invalid @enderror" id="exampleFirstName" placeholder="First Name" name="first_name" value="{{ old('first_name') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('last_name') is-invalid @enderror" id="exampleLastName" placeholder="Last Name" name="last_name" value="{{ old('last_name') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('mobile_number') is-invalid @enderror" id="exampleMobile" placeholder="Mobile Number" name="mobile_number" value="{{ old('mobile_number') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('address') is-invalid @enderror" placeholder="Address" name="address" value="{{ old('address') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('city') is-invalid @enderror" placeholder="City" name="city" value="{{ old('city') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('country') is-invalid @enderror" placeholder="Country" name="country" value="{{ old('country') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('cp') is-invalid @enderror" placeholder="Cp" name="cp" value="{{ old('cp') }}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user @error('dni') is-invalid @enderror" placeholder="dni" name="dni" value="{{ old('dni') }}">
