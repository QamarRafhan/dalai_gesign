                ...
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" placeholder="First Name" value="{{ old('first_name') ? old('first_name') : auth()->user()->first_name }}">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="labels"> <span style="color:red;">*</span>City</label>
                            <input type="text" class="form-control  @error('city') is-invalid @enderror" placeholder="City" name="city" value="{{ old('city', auth()->user()->city) }}">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="labels"> <span style="color:red;">*</span>Country</label>
                            <input type="text" class="form-control  @error('country') is-invalid @enderror" placeholder="Country" name="country" value="{{ old('country', auth()->user()->country) }}">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="labels"> <span style="color:red;">*</span>Cp</label>
                            <input type="text" class="form-control  @error('cp') is-invalid @enderror" placeholder="Cp" name="cp" value="{{ old('cp', auth()->user()->cp) }}">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="labels"> <span style="color:red;">*</span>Dni</label>
                            <input type="text" class="form-control  @error('dni') is-invalid @enderror" placeholder="dni" name="dni" value="{{ old('dni', auth()->user()->dni) }}">
